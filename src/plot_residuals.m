...
if strcmp(TransferLearning,'True')
    ...
    saveas(gcf,fullfile(wd,sprintf('net_%u_%s_%s_%s_%s_%s.jpg',...
    ...
    elseif strcmp(add_m,'True')
        ...
        saveas(gcf,fullfile(wd,sprintf('net_%u_%s_%s_%s_%s.jpg',...
    ...
    elseif strcmp(add_m,'True')
        ...
        saveas(gcf,fullfile(wd,sprintf('net_%u_%s_%s_%s.jpg',...
            round(ann2.TnC*100) ,ann2.cp,dbn_name,verNet)));
    end
end
return
